                        ...
                        for current_otp in otp_list:
                            ...
                            for g_name in pending_apps:
                                ...
                                if v_res.get("status") == "success":
                                    ...
                                    # এই ওটিপিটি একটি অ্যাপে মিলে গেছে, তাই পরবর্তী ওটিপিতে চলে যাবে
                                    break 
                                # যদি সাকসেস না হয়, তবে লুপ থামবে না, পরের অ্যাপটি চেক করবে
                        
                        # কাজ শেষে ইনপুট বক্স খালি করে অ্যাপ রিফ্রেশ হবে
                        st.rerun()
            # --- Individual List ---
